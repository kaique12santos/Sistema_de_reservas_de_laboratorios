...
const BaseLayout = () => {
  ...
  const currentDrawerWidth = isSidebarMinimized
  ...
  const drawerContent = (
    <Box
      sx={{
        ...
        borderRight: isSidebarMinimized
          ? "1px solid rgba(0,0,0,0.1)"
          : "4px solid rgba(0,0,0,0.15)",
        transition: (theme) =>
          theme.transitions.create("border-right", {
    ...
    >
          ...
          <Box>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <Box>
                ...
                <Typography
                  variant="caption"
                  sx={{ color: "rgba(255,255,255,0.6)", letterSpacing: 0.5 }}
                >
                  Centro Paula Souza
                </Typography>
              </Box>
      ...
      <List sx={{ px: isSidebarMinimized ? 1 : 2, mb: 3, mt: 1 }}>
        <ListItem disablePadding sx={{ display: "block" }}>
          <Tooltip
            title={isSidebarMinimized ? "Sair / Logout" : ""}
            placement="right"
            arrow
          >
            <ListItemButton
            ...
            >
              ...
              >
                <LogoutIcon sx={{ color: "background.eternity" }} />
              </ListItemIcon>
              <ListItemText
                primary="Sair / Logout"
                sx={{
                ...
                primary={
                  ...
                  >
                    <Typography
                      ...
                      sx={{
                        fontWeight: "bold",
                        color: isAprovada ? "success.main" : "error.main",
                      }}
                    >
                      {notif.titulo}
                    </Typography>
