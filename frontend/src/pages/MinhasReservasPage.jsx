...
const mockInicial = [
  {
    id: "09",
    dataSolicitacao: "09/02/2026",
    dataReserva: "13/02/2026",
    lab: "Lab 202",
    status: "Recusado",
    motivo: "Manutenção elétrica programada no bloco A.",
    horario: "19:00 - 20:40",
  },
  {
    id: "10",
    dataSolicitacao: "09/02/2026",
    dataReserva: "06/03/2026",
    lab: "Lab 202",
    status: "Recusado",
    motivo: "Laboratório já reservado para o curso de Redes.",
    horario: "21:00 - 22:30",
  },
  {
    id: "11",
    dataSolicitacao: "09/02/2026",
    dataReserva: "13/03/2026",
    lab: "Lab 202",
    status: "Aprovado",
    motivo: "Aula de Desenvolvimento Web.",
    horario: "19:00 - 20:40",
  },
  {
    id: "12",
    dataSolicitacao: "09/02/2026",
    dataReserva: "20/03/2026",
    lab: "Lab 202",
    status: "Aprovado",
    motivo: "Aula de Desenvolvimento Web.",
    horario: "19:00 - 20:40",
  ...
  },
  {
    id: "14",
    dataSolicitacao: "09/02/2026",
    dataReserva: "03/04/2026",
    lab: "Lab 202",
    status: "Pendente",
    motivo: "Prova bimestral de Banco de Dados.",
    horario: "21:00 - 22:30",
  },
];
...
const MinhasReservasPage = () => {
  ...
  const handleConfirmarCancelamento = () => {
    setReservas((prevReservas) =>
      prevReservas.filter((r) => r.id !== idParaCancelar),
    );
      ...
      <StaggerItem index={0}>
        ...
        >
          ...
          <TextField
            ...
            sx={{ minWidth: 200, bgcolor: "#ffffff", borderRadius: 1 }}
          >
          ...
          {reservaSelecionada && (
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} sm={6}>
                ...
                <Chip
                  label={reservaSelecionada.status}
                  color={getStatusColor(reservaSelecionada.status)}
                  size="small"
                  sx={{ fontWeight: "bold", borderRadius: 1 }}
                />
              </Grid>
      ...
      >
        ...
        <DialogContent>
          <Typography variant="body1">
            ...
            <strong>#{idParaCancelar}</strong>?
          </Typography>
          <Typography variant="body2" sx={{ color: "text.secondary", mt: 1 }}>
            Esta ação não poderá ser desfeita e você precisará fazer uma nova
            reserva caso mude de ideia.
          </Typography>
        </DialogContent>
